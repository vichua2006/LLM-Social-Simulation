...
Do not include the names of any other agents in your response.
]
"""
...
# initialize 5 agents with different prompts
agents = [autogen.AssistantAgent(name=f"Agent_{i}", system_message=memory + system_msg , llm_config=llm_config) for i, memory in enumerate(agent_memories, 1)]
...
# both methods are reliable, the groupchar arguably more
